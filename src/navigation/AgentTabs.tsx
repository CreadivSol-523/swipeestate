...
const ListStack = (): JSX.Element => {
     return (
          <ListStackNavigator.Navigator screenOptions={{ headerShown: false }}>
               ...
               <ListStackNavigator.Screen name="EditProfileScreen" component={EditProfileScreen} options={{ headerShown: false }} />
               <ListStackNavigator.Screen name="ChangePasswordScreen" component={ChangePasswordScreen} options={{ headerShown: false }} />
